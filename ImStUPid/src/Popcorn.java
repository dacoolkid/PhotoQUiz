...
public class Popcorn {
	...
	public static void main(String[] args) {
		Popcorn poptart = new Popcorn("poptart");
		Microwave poptartcooker = new Microwave();
		poptartcooker.putInMicrowave(poptart);
		poptartcooker.setTime(2);
		poptartcooker.startMicrowave();
		poptart.applyHeat();
	}
